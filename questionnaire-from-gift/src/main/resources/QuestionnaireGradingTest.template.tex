...
{%
  \ifthenelse{\value{TableLoopCounter} = #1}
  {
      \addtocounter{#2}{1}%
      #4 \\ \hline%
    \end{tabular}
  }
  {
    ...
    {%
      \begin{tabular}{#3}%
        \hline %
        \addtocounter{#2}{1}%
        \addtocounter{TableLoopCounter}{1}%
...
\newcommand{\TableLoop}[4]
{
  ...
  % #3: colum definitions
  % #4: body of each row
  \newcounter{TableLoopCounter}
  \setcounter{TableLoopCounter}{1}
  \setcounter{#2}{0}
  \TableLoopInternal{#1}{#2}{#3}{#4}
}
...
\newcommand{\AnswerTable}[1]
{
  ...
  \newcommand{\UseAndAvanceAnswerCounter}{\addtocounter{AnswerCounter}{1}\arabic{AnswerCounter}}
  ...
  {AnswerCounter}
  {|r|r|}
  { \arabic{AnswerCounter} & \QuestionFill }


  \TableLoop{#1}
  {AnswerCounter}
  {|r|p{\AnswerWidth}|r|p{\AnswerWidth}|r|p{\AnswerWidth}|r|p{\AnswerWidth}|r|p{\AnswerWidth}|}
  {\arabic{AnswerCounter} & \QuestionFill & \UseAndAvanceAnswerCounter & \QuestionFill & \UseAndAvanceAnswerCounter & \QuestionFill  & \UseAndAvanceAnswerCounter & \QuestionFill & \UseAndAvanceAnswerCounter & \QuestionFill }
