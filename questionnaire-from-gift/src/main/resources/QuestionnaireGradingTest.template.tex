...
\newcommand{\HorizontalAnswerTable}[1]
{
  ...
  \newcommand{\AnswerWidth}{2.7cm}
  \newcommand{\QuestionFill}{}

  \newcounter{AnswerCounter}
  \newcommand{\UseAnswerCounter}{\ifthenelse{\value{AnswerCounter}>#1}{}{\arabic{AnswerCounter}}}
  \newcommand{\UseAndAvanceAnswerCounter}{\addtocounter{AnswerCounter}{1}\UseAnswerCounter}

  \newcommand{\AnswerCell}
  {
    \ifthenelse{\value{AnswerCounter}>#1}
    {}
    {
      \begin{tabular}{|p{0.5cm}|p{1.5cm}|}
        \hline
        \arabic{AnswerCounter} &  \\
        \hline
      \end{tabular}
    }
  }
  ...
  %\TableLoop{#1}
  %{AnswerCounter}
  %{ p{\AnswerWidth} p{\AnswerWidth} p{\AnswerWidth} p{\AnswerWidth} p{\AnswerWidth} }
  %{
  %  \AnswerCell \addtocounter{AnswerCounter}{1} & \AnswerCell \addtocounter{AnswerCounter}{1} & \AnswerCell \addtocounter{AnswerCounter}{1} & \AnswerCell \addtocounter{AnswerCounter}{1} & \AnswerCell
  %}

  \begin{tabular}{p{\AnswerWidth} p{\AnswerWidth} p{\AnswerWidth} p{\AnswerWidth} p{\AnswerWidth}}
    \forloop[5]{AnswerCounter}{1}{\value{AnswerCounter}<#1 \OR \value{AnswerTableC}=#1}
    {
      \AnswerCell \addtocounter{AnswerCounter}{1} & \AnswerCell \addtocounter{AnswerCounter}{1} & \AnswerCell \addtocounter{AnswerCounter}{1} & \AnswerCell \addtocounter{AnswerCounter}{1} & \AnswerCell \\
      \hline
...
\newcommand{\AnswerTable}[1]{\HorizontalAnswerTable{#1}\VerticalAnswerTable{#1}}
