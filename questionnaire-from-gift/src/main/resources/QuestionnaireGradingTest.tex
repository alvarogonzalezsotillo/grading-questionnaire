...
\begin{FullPageOpenQuestion}Explica qué apartados debe incluir un plan de contingencias\end{OpenQuestion}
\begin{FullPageOpenQuestion}Determina si cada una de estas medidas que aumentan la seguridad informática son activas o pasivas, especificando el por qué de esa clasificación: Cuotas de disco, discos redundantes (RAID), antivirus, autentificación mediante contraseñas\end{OpenQuestion}
