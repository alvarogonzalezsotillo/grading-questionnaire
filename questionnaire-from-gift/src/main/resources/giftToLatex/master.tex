...
\newcommand{\Instructions}[2]
{
  \begin{small}
    ...
    \begin{itemize}
      \item No se tendrán en cuenta anotaciones fuera de la tabla de respuestas, excepto para alumnos con derecho a adaptaciones en la evaluación.
      ...
      \item Un aspa marca una respuesta. Se puede desmarcar una respuesta con un círculo sobre el aspa.
    \end{itemize}
    \vfill\columnbreak
    ...
    \end{multicols}
    \vspace{0.3cm}
    El estudiante dispone de 90 minutos para entregar el examen. Los estudiantes con derecho a adaptaciones en la evaluación pueden utilizar hasta 110 minutos
  \end{small}
}
...
\newcommand{\LetterAnswerCellTemplate}[1]{%
  ...
  \begin{tabular}{p{0.7cm}@{\hskip 0.4cm}!{\color{light-gray}\vrule}p{1.3cm}!{\color{light-gray}\vrule}}%
    \arrayrulecolor{light-gray}\cline{2-2}%
    \cellcolor{black}\textcolor{white}{\hfill #1 \hfill} &  \hfill \\[2pt]%
    \arrayrulecolor{light-gray}\cline{2-2}%
  \end{tabular}%
}
...
\newcommand{\TickedAnswerCellTemplate}[5]{%
  ...
  \begin{tabular}{x{1.0cm}@{\hskip 0.1cm}!{\color{light-gray}\vrule}@{}x{\TickWidth}@{}!{\color{light-gray}\vrule}@{}x{\TickWidth}@{}!{\color{light-gray}\vrule}@{}x{\TickWidth}@{}!{\color{light-gray}\vrule}@{}x{\TickWidth}@{}!{\color{light-gray}\vrule}}%
...
%\FirstPage{30}{70}{51}{false}{true}% horizontal ticked
