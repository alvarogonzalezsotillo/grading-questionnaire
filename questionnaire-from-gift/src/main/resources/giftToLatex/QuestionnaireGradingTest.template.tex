...
\newcommand{\Instructions}[2]
{
  \begin{small}
    ...
    \begin{itemize}
      \item No se tendrán en cuenta anotaciones fuera de la tabla de respuestas. Utiliza \textbf{MAYÚSCULAS}.
...
\newcommand{\AnswerCellTemplate}[1]{\TickedAnswerCellTemplate{#1}{}{}{}{}}
...
\newcommand{\HorizontalAnswerTable}[1]
{
  ...
  \forloop[5]{DummyAnswerCounter}{-4}{\value{DummyAnswerCounter}<#1 \OR \value{AnswerTableC}=#1}
  {
    \AnswerCell %\hfill
    \AnswerCell %\hfill
    \AnswerCell %\hfill
...
\newcommand{\HorizontalAnswerTableDisabled}[1]
{
  \vspace{0.5cm}
