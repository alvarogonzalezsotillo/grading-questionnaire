...
Android solo admite formato =p12= para los certificados, así que hay que convertirlo desde =rootCA.pem=
#+begin_src sh
openssl pkcs12 -export -out rootCA.p12 -in rootCA.pem -inkey rootCA.key -passin pass:1234 -passout "pass:"
#+end_src
